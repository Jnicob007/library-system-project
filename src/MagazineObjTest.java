...
public class MagazineObjTest {
    ...
    void setUp() throws InvalidPublicationException {
        ...
        magazines.add(new MagazineObj(1, "Tech World", MagazineObj.Topic.TECHNOLOGY, Date.valueOf(LocalDate.of(2022, 1, 10)), 1, 100, 8));
        magazines.add(new MagazineObj(2, "Healthy Life", MagazineObj.Topic.BUSINESS, Date.valueOf(LocalDate.of(2023, 5, 5)), 2, 80, 5));
        magazines.add(new MagazineObj(3, "Travel Planet", MagazineObj.Topic.TRAVEL, Date.valueOf(LocalDate.of(2021, 11, 1)), 3, 50, 6));
    }

    //Test poprawnego tworzenia obiektu
    @Test
    void testMagazineCreation() throws InvalidPublicationException {
        MagazineObj mag = new MagazineObj("Business Weekly", MagazineObj.Topic.LIFESTYLE, Date.valueOf(LocalDate.now()), 1, 120, 10);
    ...
    void testInvalidMagazineThrowsException() {
        assertThrows(InvalidPublicationException.class, () -> {
            new MagazineObj("", MagazineObj.Topic.HEALTH, Date.valueOf(LocalDate.now()), 1, 50, 4);
        });
        assertThrows(InvalidPublicationException.class, () -> {
            new MagazineObj("Tech Guide", MagazineObj.Topic.TECHNOLOGY, Date.valueOf(LocalDate.now()), 1, -5, 4);
        });
    }
    ...
    void testAddAndRemoveMagazine() throws InvalidPublicationException {
        MagazineObj newMag = new MagazineObj("Fashion Now", MagazineObj.Topic.LIFESTYLE, Date.valueOf(LocalDate.now()), 4, 70, 6);
